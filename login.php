...
<form action = "booking.php" method="post">
  ...
  <div class="container register">
	  <p>Doesn't have an account? <a href="..\GoCheeta\register.php">Register</a>.</p>
  </div>
  <div>
	<p>Log as an Admin <a href="..\GoCheeta\admin_login.php">Admin Loggin</a>.</p>
	<p>Log as a Driver <a href="..\GoCheeta\driver_login.php">Driver Loggin</a>.</p>
  </div>
